/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb790c74b23b5013da48a62061bafc01)
// Runtime types generated with workerd@1.20260911.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	EVENTS: Queue;
	ORIGIN_URL: "https://door-sync.example.org";
	CIVICRM_WEBHOOK_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ORIGIN_URL" | "CIVICRM_WEBHOOK_SECRET" | "ORIGIN_HMAC_SECRET" | "CF_ACCESS_CLIENT_ID" | "CF_ACCESS_CLIENT_SECRET">> {}
}
